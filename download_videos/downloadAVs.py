...
class download_videos(object):
    ...
    def __init__(self):
        ...
        self.m3u8_url = "http://prev.fuyoupin.net/webapp/32/1500kb/hls/index.m3u8" #
        # self.m3u8_url = "http://qiezsp889911.chuantouchi.com:8092/20190422/z3DkqsbW/1500kb/hls/index.m3u8"
        self.ts = []
        self.download_path = os.getcwd() + '/av/'
        self.filename = "m3u8"
        self.key = ""
    ...
    def downloader(self):
        ...
        key_url = self.m3u8_url.replace('index.m3u8',key_uri)
        #请求key
